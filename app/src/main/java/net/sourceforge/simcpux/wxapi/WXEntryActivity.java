...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler{
			...
			switch (tag) {
				case NetworkUtil.GET_TOKEN: {
					...
					try {
						...
						Toast.makeText(wxEntryActivityWeakReference.get(), "json : " + json, Toast.LENGTH_LONG).show();
	...
	public void onResp(BaseResp resp) {
		...
		Log.e("NetworkUtil", getString(result) + ", type=" + resp.getType());
		...
		if (resp.getType() == ConstantsAPI.COMMAND_SENDAUTH) {
			...
			Log.e("code", "https://api.weixin.qq.com/sns/oauth2/access_token?appid=wxd930ea5d5a258f4f&secret=1d6d1d57a3dd063b36d917bc0b44d964&code="+code+"&grant_type=authorization_code");
			// https://api.weixin.qq.com/sns/oauth2/access_token?appid=wxd930ea5d5a258f4f&secret=1d6d1d57a3dd063b36d917bc0b44d964&code=CODE&grant_type=authorization_code
